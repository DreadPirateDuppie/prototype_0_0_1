-- Migration: Add wagering and timer functionality to battles
...
-- Add wagering and timer columns to battles table
...
COMMENT ON COLUMN profiles.points IS 'User points balance for wagering on battles';
